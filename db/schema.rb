...
ActiveRecord::Schema.define(version: 2021_01_16_174705) do
  ...
  create_table "subscribes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["micropost_id"], name: "index_subscribes_on_micropost_id"
    t.index ["user_id", "micropost_id"], name: "index_subscribes_on_user_id_and_micropost_id", unique: true
  ...
  add_foreign_key "subscribes", "microposts"
